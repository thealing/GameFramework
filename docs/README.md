...
### The Game Loop
The framework collects input and state changes using a background event queue. The game can process new events at the start of each frame, then proceed with the update and rendering phases, like in this simplified example:
```c
